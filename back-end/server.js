...
function Meetup(meetup) {
  ...
  this.event_date = new Date(meetup.time).toString().slice(0, 15);
  this.host = meetup.venue ? meetup.venue.name : 'TBD';
  this.created_at = Date.now();
}
...
Meetup.prototype = {
  save: function (location_id) {
    const SQL = `INSERT INTO ${this.tableName} (link, name, event_date, host, created_at, location_id) VALUES ($1, $2, $3, $4, $5, $6);`;
    const values = [this.link, this.name, this.event_date, this.host, this.created_at, location_id];
